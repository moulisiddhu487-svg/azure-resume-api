...
# Your complete resume data structured in standard JSON format
RESUME_DATA = {
  "basics": {
  ...
  "skills": [
    ...
    },
    {
      ...
      "keywords": ["Linux (Ubuntu/RHEL)", "Bash", "Windows"]
    },
    {
      "name": "Languages & APIs",
  ...
  "projects": [
    {
      ...
      "keywords": ["Python", "Azure Functions", "GitHub Actions", "REST API"],
      "url": "https://resume-api-30847.azurewebsites.net/api/cv"
    },
    {
      ...
      "keywords": ["Docker", "GitHub Actions", "Linux"],
  ...
  "languages": [
    {"language": "Telugu", "fluency": "Native"},
    {"language": "Hindi", "fluency": "Fluent"},
    {"language": "English", "fluency": "Fluent"}
  ]
}

# Main endpoint: Returns formatted JSON text
...
# Root endpoint: Returns formatted JSON text directly
